...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function handleSubmit(event) {
      event.preventDefault();
      var sortinator = this.state.stringToSubmit;

      _axios2.default.post(baseURL + '/sortinator', { sortinator: sortinator }).then(function (result) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'label',
          null,
          'Input a String for Sorting!'
        ),
        _react2.default.createElement('input', { value: this.state.stringToSubmit, onChange: this.handleInput, type: 'text' }),
        _react2.default.createElement(
          'button',
          null,
          'Click to Submit!'
